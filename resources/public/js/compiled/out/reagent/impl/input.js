...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__12239){
var map__12240 = p__12239;
var map__12240__$1 = cljs.core.__destructure_map.call(null,map__12240);
var on_write = cljs.core.get.call(null,map__12240__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
}):(cljs.core.truth_((function (){var and__4149__auto__ = original_ref_fn;
if(cljs.core.truth_(and__4149__auto__)){
...
(jsprops.onChange = (function (p1__12241_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__12241_SHARP_);
}));

...
var G__12246 = o;
goog.object.set(G__12246,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__12247__delegate = function (args){
...
return G__12247__delegate.call(this,args);};
...
return G__12247__delegate(args);
});
...
var G__12250 = o;
goog.object.set(G__12250,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__12252__i < G__12252__a.length) {G__12252__a[G__12252__i] = arguments[G__12252__i + 0]; ++G__12252__i;}
  args = new cljs.core.IndexedSeq(G__12252__a,0,null);
} 
...
var G__12254 = props;
var G__12254__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__12254,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__12254);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12254__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,(function (){var or__4160__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__12255 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__12255,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__12255;
}
})(),id_class);
...
var G__12256 = (cljs.core.count.call(null,argv) - first_child);
switch (G__12256) {
case (0):
...
var vec__12258 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__12258,(0),null);
var id = cljs.core.nth.call(null,vec__12258,(1),null);
var className = cljs.core.nth.call(null,vec__12258,(2),null);
...
var temp__5757__auto___12261 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___12261 == null)){
} else {
var key_12262 = temp__5757__auto___12261;
(jsprops.key = key_12262);
}
...
var temp__5757__auto___12263 = reagent.impl.util.react_key_from_vec.call(null,v);
if((temp__5757__auto___12263 == null)){
} else {
var key_12264 = temp__5757__auto___12263;
(jsprops.key = key_12264);
}
...
var temp__5757__auto___12265 = reagent.impl.util.react_key_from_vec.call(null,argv);
if((temp__5757__auto___12265 == null)){
} else {
var key_12266 = temp__5757__auto___12265;
...
var temp__5757__auto___12267 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___12267 == null)){
} else {
var key_12268 = temp__5757__auto___12267;
...
var temp__5757__auto___12269 = reagent.impl.util.get_react_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5757__auto___12269 == null)){
} else {
var key_12270 = temp__5757__auto___12269;
(jsprops.key = key_12270);
}
...
return cljs.core.into_array.call(null,cljs.core.map.call(null,(function (p1__12271_SHARP_){
return reagent.impl.protocols.as_element.call(null,compiler,p1__12271_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__12272 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx,compiler);
}));
var res = cljs.core.nth.call(null,vec__12272,(0),null);
var derefed = cljs.core.nth.call(null,vec__12272,(1),null);
...
break;
default:
var G__12277 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
var G__12278 = compiler;
v = G__12277;
compiler = G__12278;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template12282 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template12282 = (function (opts,id,fn_to_element,meta12283){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template12282.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_12284,meta12283__$1){
var self__ = this;
var _12284__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template12282(self__.opts,self__.id,self__.fn_to_element,meta12283__$1));
}));

(reagent.impl.template.t_reagent$impl$template12282.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_12284){
var self__ = this;
var _12284__$1 = this;
return self__.meta12283;
}));

(reagent.impl.template.t_reagent$impl$template12282.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template12282.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template12282.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element.call(null,this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template12282.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element.call(null,this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template12282.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta12283","meta12283",825524963,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template12282.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template12282.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template12282");

(reagent.impl.template.t_reagent$impl$template12282.cljs$lang$ctorPrWriter = (function (this__4404__auto__,writer__4405__auto__,opt__4406__auto__){
return cljs.core._write.call(null,writer__4405__auto__,"reagent.impl.template/t_reagent$impl$template12282");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template12282.
 */
reagent.impl.template.__GT_t_reagent$impl$template12282 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template12282(opts__$1,id__$1,fn_to_element__$1,meta12283){
return (new reagent.impl.template.t_reagent$impl$template12282(opts__$1,id__$1,fn_to_element__$1,meta12283));
});

}

return (new reagent.impl.template.t_reagent$impl$template12282(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});

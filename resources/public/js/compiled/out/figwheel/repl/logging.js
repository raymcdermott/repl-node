...
try{return cljs.core.reduce.call(null,cljs.core._PLUS_,cljs.core.map.call(null,cljs.core._STAR_,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [(100000000000),(10000),(1)], null),cljs.core.map.call(null,(function (p1__9075_SHARP_){
return parseInt(p1__9075_SHARP_);
...
var c_9078 = (new goog.debug.Console());
var G__9077_9079 = c_9078.getFormatter();
goog.object.set(G__9077_9079,"showAbsoluteTime",false);

goog.object.set(G__9077_9079,"showRelativeTime",false);


goog.object.set(goog.debug.Console,"instance",c_9078);
...
figwheel.repl.logging.log_levels = cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.call(null,cljs.core.juxt.call(null,clojure.string.lower_case,(function (p1__9080_SHARP_){
return goog.object.get(goog.debug.Logger.Level,p1__9080_SHARP_);

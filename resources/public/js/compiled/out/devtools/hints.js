...
var reader = (function (){var or__4160__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__4160__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
return (128);
...
}catch (e38235){var _e = e38235;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5751__auto___38237 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5751__auto___38237)){
var seen_errors_38238 = temp__5751__auto___38237;
if(cljs.core.truth_(seen_errors_38238.has(self))){
} else {
seen_errors_38238.add(self);

var temp__5753__auto___38239 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5753__auto___38239)){
var sense_38240 = temp__5753__auto___38239;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_38240)].join(''));
} else {
}
}
} else {

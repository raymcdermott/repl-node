...
var len__4771__auto___37686 = arguments.length;
var i__4772__auto___37687 = (0);
while(true){
if((i__4772__auto___37687 < len__4771__auto___37686)){
args__4777__auto__.push((arguments[i__4772__auto___37687]));

var G__37688 = (i__4772__auto___37687 + (1));
i__4772__auto___37687 = G__37688;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq37683){
...
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37684,G__37685,seq37683__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__37689_SHARP_){
return (!((cljs.core.meta.call(null,p1__37689_SHARP_) == null)));
})))){
...
var map__37690 = opts;
var map__37690__$1 = cljs.core.__destructure_map.call(null,map__37690);
var markup_db = cljs.core.get.call(null,map__37690__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e37693){var _e__36667__auto__ = e37693;
return false;
}})();
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
...
}catch (e37695){var _e__36667__auto__ = e37695;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__37697 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__37698 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__37698);

try{var map__37699 = opts;
var map__37699__$1 = cljs.core.__destructure_map.call(null,map__37699);
var markup_db = cljs.core.get.call(null,map__37699__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__37697);
}});
...
var temp__5751__auto___37703 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5751__auto___37703)){
var managed_print_level_37704 = temp__5751__auto___37703;
var _STAR_print_level_STAR__orig_val__37701_37705 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__37702_37706 = managed_print_level_37704;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__37702_37706);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__37700_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__37700_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__37701_37705);
}} else {
job_fn.call(null);
}

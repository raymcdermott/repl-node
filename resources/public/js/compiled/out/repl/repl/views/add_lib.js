...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.v_box,new cljs.core.Keyword(null,"gap","gap",80255254),"20px",new cljs.core.Keyword(null,"children","children",-940561982),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.doall.call(null,(function (){var iter__4564__auto__ = (function repl$repl$views$add_lib$lib_type_$_iter__33403(s__33404){
return (new cljs.core.LazySeq(null,(function (){
var s__33404__$1 = s__33404;
while(true){
var temp__5753__auto__ = cljs.core.seq.call(null,s__33404__$1);
if(temp__5753__auto__){
var s__33404__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__33404__$2)){
var c__4562__auto__ = cljs.core.chunk_first.call(null,s__33404__$2);
var size__4563__auto__ = cljs.core.count.call(null,c__4562__auto__);
var b__33406 = cljs.core.chunk_buffer.call(null,size__4563__auto__);
if((function (){var i__33405 = (0);
while(true){
if((i__33405 < size__4563__auto__)){
var maven_QMARK_ = cljs.core._nth.call(null,c__4562__auto__,i__33405);
cljs.core.chunk_append.call(null,b__33406,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.radio_button,new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.name.call(null,maven_QMARK_),new cljs.core.Keyword(null,"value","value",305978217),maven_QMARK_,new cljs.core.Keyword(null,"model","model",331153215),(cljs.core.truth_(new cljs.core.Keyword(null,"maven","maven",155779801).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lib_data)))?new cljs.core.Keyword(null,"maven","maven",155779801):new cljs.core.Keyword(null,"git","git",-163493751)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (i__33405,maven_QMARK_,c__4562__auto__,size__4563__auto__,b__33406,s__33404__$2,temp__5753__auto__){
return (function (p1__33402_SHARP_){
return cljs.core.swap_BANG_.call(null,lib_data,cljs.core.assoc,new cljs.core.Keyword(null,"maven","maven",155779801),cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"maven","maven",155779801),p1__33402_SHARP_));
});})(i__33405,maven_QMARK_,c__4562__auto__,size__4563__auto__,b__33406,s__33404__$2,temp__5753__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),maven_QMARK_], null)));

var G__33407 = (i__33405 + (1));
i__33405 = G__33407;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33406),repl$repl$views$add_lib$lib_type_$_iter__33403.call(null,cljs.core.chunk_rest.call(null,s__33404__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__33406),null);
}
} else {
var maven_QMARK_ = cljs.core.first.call(null,s__33404__$2);
return cljs.core.cons.call(null,cljs.core.with_meta(new cljs.core.PersistentVector(null, 9, 5, cljs.core.PersistentVector.EMPTY_NODE, [re_com.core.radio_button,new cljs.core.Keyword(null,"label","label",1718410804),cljs.core.name.call(null,maven_QMARK_),new cljs.core.Keyword(null,"value","value",305978217),maven_QMARK_,new cljs.core.Keyword(null,"model","model",331153215),(cljs.core.truth_(new cljs.core.Keyword(null,"maven","maven",155779801).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,lib_data)))?new cljs.core.Keyword(null,"maven","maven",155779801):new cljs.core.Keyword(null,"git","git",-163493751)),new cljs.core.Keyword(null,"on-change","on-change",-732046149),((function (maven_QMARK_,s__33404__$2,temp__5753__auto__){
return (function (p1__33402_SHARP_){
return cljs.core.swap_BANG_.call(null,lib_data,cljs.core.assoc,new cljs.core.Keyword(null,"maven","maven",155779801),cljs.core._EQ_.call(null,new cljs.core.Keyword(null,"maven","maven",155779801),p1__33402_SHARP_));
});})(maven_QMARK_,s__33404__$2,temp__5753__auto__))
], null),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"key","key",-1516042587),maven_QMARK_], null)),repl$repl$views$add_lib$lib_type_$_iter__33403.call(null,cljs.core.rest.call(null,s__33404__$2)));
}
} else {
return null;
}

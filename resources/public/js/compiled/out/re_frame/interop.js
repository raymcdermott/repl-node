...
return [(function (){var pred__35304 = cljs.core.instance_QMARK_;
var expr__35305 = reactive_val;
if(cljs.core.truth_(pred__35304.call(null,reagent.ratom.RAtom,expr__35305))){
return "ra";
} else {
if(cljs.core.truth_(pred__35304.call(null,reagent.ratom.RCursor,expr__35305))){
return "rc";
} else {
if(cljs.core.truth_(pred__35304.call(null,reagent.ratom.Reaction,expr__35305))){
return "rx";
} else {
if(cljs.core.truth_(pred__35304.call(null,reagent.ratom.Track,expr__35305))){
return "tr";
} else {
return "other";
}

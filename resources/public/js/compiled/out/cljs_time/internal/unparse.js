...
var periods__$1 = cljs.core.vec.call(null,(function (){var G__17739 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.call(null,(function (p1__17738_SHARP_){
return cljs.core.subs.call(null,p1__17738_SHARP_,(0),(3));
}),G__17739);
} else {
return G__17739;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__17748){
var vec__17749 = p__17748;
var t = cljs.core.nth.call(null,vec__17749,(0),null);
var pattern = cljs.core.nth.call(null,vec__17749,(1),null);
if(cljs.core._EQ_.call(null,t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__17752 = pattern;
switch (G__17752) {
case "S":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17752)].join('')));
...
return p1__17754_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__17755_SHARP_){
return p1__17755_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__17756_SHARP_){
return p1__17756_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__17757_SHARP_){
return p1__17757_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__17758_SHARP_){
return p1__17758_SHARP_.getHours();
});

break;
case "day":
return (function (p1__17759_SHARP_){
return p1__17759_SHARP_.getDate();
});

break;
case "month":
return (function (p1__17760_SHARP_){
return p1__17760_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__17761_SHARP_){
return p1__17761_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__17764){
var vec__17765 = p__17764;
var seq__17766 = cljs.core.seq.call(null,vec__17765);
var first__17767 = cljs.core.first.call(null,seq__17766);
var seq__17766__$1 = cljs.core.next.call(null,seq__17766);
var key = first__17767;
var args = seq__17766__$1;
var G__17768 = key;
...
break;
case "ordinal-suffix":
var vec__17769 = syntax_list.call(null,(i - (1)));
var k = cljs.core.nth.call(null,vec__17769,(0),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__17768__$1)].join('')));
...
var d = value;
var G__17776 = cljs.core.map_indexed.call(null,cljs.core.partial.call(null,cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__17777 = G__17776;
...
var unparser = first__17779;
var more = seq__17778__$1;
var s = "";
var d__$1 = d;
...
while(true){
var d__$2 = d__$1;
var vec__17786 = G__17776__$1;
var seq__17787 = cljs.core.seq.call(null,vec__17786);
var first__17788 = cljs.core.first.call(null,seq__17787);
var seq__17787__$1 = cljs.core.next.call(null,seq__17787);
var unparser__$1 = first__17788;
var more__$1 = seq__17787__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__17789 = unparser__$1.call(null,s__$2,d__$2);
var s__$3 = cljs.core.nth.call(null,vec__17789,(0),null);
var d__$3 = cljs.core.nth.call(null,vec__17789,(1),null);
var G__17792 = d__$3;
var G__17793 = more__$1;
var G__17794 = s__$3;
d__$1 = G__17792;
G__17776__$1 = G__17793;
s__$1 = G__17794;
continue;
}
break;
